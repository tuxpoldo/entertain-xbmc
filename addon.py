...
def addEntertainChannel(url,name,all=False,icon=False,thumbnail=False,poster=False,fanart=False, plot='', genre=language(30090),year='2014',duration='90',hdurl=False):
	if (not hdurl):
